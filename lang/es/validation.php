...
return [
    ...
    "attributes" => [
        ...
        "reasignado" => "reasignado a",
        "fecha_reasignacion" => "fecha de reasignación",
        "arquitecto_responsable" => "arquitecto responsable",
        "clave_catastral" => "clave catastral",
        "estado_tramite" => "estado del trámite",
        "estado_ingreso" => "estado de ingreso",
        "id_aforo" => "aforo",
        "uso_suelo" => "uso de suelo",
        "local_comercial" => "local comercial",
        "aforo_personas" => "aforo de personas",
        "inspeccion" => "inspección",
        "id_planosarq" => "plano arquitectónico",
        "anteproyecto" => "anteproyecto",
        "definitivo" => "definitivo",
        "modificatorio" => "modificatorio",
        "ampliatorio" => "ampliatorio",
        "area_construccion" => "área de construcción",
        "area_construccion2" => "otra área de construcción",
        "id_fraccionamiento" => "fraccionamiento",
        "area_aprobada" => "área aprobada",
        "id_unificacion" => "unificación",
        "id_trabajov" => "trabajo vario",

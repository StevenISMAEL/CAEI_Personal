        ...
        <div ref={wrapperRef} className={`${className}`}>
            <div className="relative">
                <FloatInputText
                    ...
                    className="w-full px-4 py-2 text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-gray-500 focus:outline-none focus:ring-0 focus:border-gray-600"
                />
            ...
            {isOpen && (
                <div className="mt-2 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-lg">
                    <ul className="py-1 max-h-20 overflow-auto focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
